<?php
/**
 * The 'Rsssl_Event' class is a part of the 'Really Simple SSL pro' plugin,
 * which is developed by the company 'Really Simple Plugins'.
 * This class is responsible for handling the event data.
 *
 * @package     REALLY_SIMPLE_SSL\Security\WordPress\Eventlog\Models  // The categorization of this class.
 */

namespace REALLY_SIMPLE_SSL\Security\WordPress\Eventlog\Models;
 ...
 *
 * @package     REALLY_SIMPLE_SSL\Security\WordPress\Eventlog\Models
 */
class Rsssl_Event {
