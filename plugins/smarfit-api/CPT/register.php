...
new CustomPostTypeAPI('Comercios', 'comercios', array('filtros'), 'building', 'post', 'comercios', false, true, 'comercios' );

add_action( 'init', 'register_custom_taxonomy', 10 );
function register_custom_taxonomy() {
  new CustomTaxonomyAPI('Filtros', true, 'filter', 'filtros', array('comercios'));
}
